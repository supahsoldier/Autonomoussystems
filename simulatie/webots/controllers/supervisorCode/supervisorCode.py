...
# Needed MQTT topics
chariotPositionTopics = ["chariot/1/position", "chariot/3/position", "chariot/4/position", "chariot/5/position", "chariot/6/position", "chariot/2/position"]
chariotTargetTopics = ["chariot/1/target", "chariot/3/target", "chariot/4/target", "chariot/5/target", "chariot/6/target", "chariot/2/target"]
chariotStatusTopics = ["chariot/1/status", "chariot/3/status", "chariot/4/status", "chariot/5/status", "chariot/6/status", "chariot/2/status"]
...
chariotNodes = [chariotNodes[0], chariotNodes[2], chariotNodes[3], chariotNodes[4], chariotNodes[5], chariotNodes[1]]
